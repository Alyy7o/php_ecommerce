    ...
    <div class="page-content">
        <div class="page-header">
            ...
            <tr>
                ...
                <td><a href="edit_sub.php?id=<?php echo $row['id']; ?>" class="btn btn-success">EDIT</a></td>
                <td><a href="delete_sub.php?id=<?php echo $row['id']; ?>" onclick="confirmation(event)" class="btn btn-danger">DELETE</a></td>
            </tr>
